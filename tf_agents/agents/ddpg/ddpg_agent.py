...
class DdpgAgent(tf_agent.TFAgent):
  ...
  def __init__(self,
    ...
    individual_time_step_spec = ts.get_individual_time_step_spec(time_step_spec)
    policy = actor_policy.ActorPolicy(
        time_step_spec=individual_time_step_spec, action_spec=action_spec,
  ...
  def critic_loss(self,
    ...
    """
    """Nitty: edited to calculate loss with all actions and observations"""
